...
import { inviteSchema } from "~console/routes/_shell.w.$workspaceSlug.settings.members/invite-schema";

import type { clientAction } from "../_shell.w.$workspaceSlug.settings.members/route";
      ...
      {canManage && (
        <>
          ...
          >
            ...
            <input type="hidden" name="teamId" value={workspace.team_id} />
