...
export const gw = gateway({
  ...
  models: defineModelCatalog(
    ...
    claudeOpus46({ providers: ["bedrock", "vertex", "anthropic"], ...withTier("anthropic/claude-opus-4.6") }),
    claudeSonnet46({ providers: ["bedrock", "vertex", "anthropic"], ...withTier("anthropic/claude-sonnet-4.6") }),
    claudeHaiku45({ providers: ["bedrock", "vertex", "anthropic"], ...withTier("anthropic/claude-haiku-4.5") }),
